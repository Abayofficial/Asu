...
const exif = new Exif();
//ೋ❀❀ೋ═══[SUBSCRIBE RAMDANI OFFICIAL]═══ೋ❀❀ೋ//
const { allMenu, downloadMenu, infoMenu, gameMenu, groupMenu, funMenu, wibuMenu, ownerMenu, stickerMenu, otherMenu, rulesBot, islamMenu, sertiMenu, ceritaMenu, makerMenu,dewasaMenu, toolsMenu} = require('./message/help.js')
...
module.exports = Ramdani = async (Ramdani, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Ramdani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© Abay 𝐶ℎ𝑎𝑛𝑒𝑙᭄𓅂","listType": "SINGLE_SELECT","sections": list}}, {})
      ...
      const hideTag = async function(from, text){
	       ...
	       Ramdani.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('media/Ramdani3.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}  
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/Ramdani3.jpg`)},"title": `© Abay 𝐶ℎ𝑎𝑛𝑒𝑙᭄𓅂`,"description": "Ramdani Official", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Ramdani Official","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}

      // Anti link
        if (isGroup && isAntiLink && !isOwner && !isGroupAdmins && isBotGroupAdmins){
            if (budy.match(/(https:\/\/chat.whatsapp.com)/gi)) {
                reply(`*「 GROUP LINK DETECTOR 」*\nBaca desk, dah di bilang jgn share link grup lain, mampus kena kick`)
...
`
               buttons = [{buttonId: `${prefix}allmenu`,buttonText:{displayText: 'ᴀʟʟᴍᴇɴᴜ'},type:1},{buttonId: `${prefix}command`,buttonText:{displayText: 'sɪᴍᴘᴇʟ ᴍᴇɴᴜ'},type:1},{buttonId: `${prefix}sm`,buttonText:{displayText: 'sᴛᴏʀᴇ ᴍᴇɴᴜ'},type:1}]
...
│❏ヅ ${prefix}marvel  
│❏ヅ ${prefix}marvel2  
│❏ヅ ${prefix}cinematichorror  
│❏ヅ ${prefix}avengers  
│❏ヅ ${prefix}graffiti3  
│❏ヅ ${prefix}captainamerica  
│❏ヅ ${prefix}girlneko  
│❏ヅ ${prefix}sadboy  
│❏ヅ ${prefix}kaneki  
│❏ヅ ${prefix}rem  
...
╭─⬣「 *OTHER MENU* 」⬣
│❏ヅ ${prefix}brainly *query*
│❏ヅ ${prefix}cerpen
│❏ヅ ${prefix}shopee *product*
│❏ヅ ${prefix}playstore *query*
│❏ヅ ${prefix}ssweb *query*
│❏ヅ ${prefix}google *query*
...
│❏ヅ ${prefix}ayam
│❏ヅ ${prefix}burung
│❏ヅ ${prefix}burung hantu
│❏ヅ ${prefix}burung gagak
│❏ヅ ${prefix}burung puyuh
│❏ヅ ${prefix}bebek
│❏ヅ ${prefix}angsa
│❏ヅ ${prefix}sapi
│❏ヅ ${prefix}kuda
...
│❏ヅ ${prefix}doujindesu
│❏ヅ ${prefix}storyanime
│❏ヅ ${prefix}otakuongoing
│❏ヅ ${prefix}nhentai *code*
│❏ヅ ${prefix}nekopoi *link*
└⬣
...
│❏ヅ ${prefix}darkjoke
└⬣`
               buttons = [{buttonId: `${prefix}storemenu`,buttonText:{displayText: 'sᴛᴏʀᴇ ᴍᴇɴᴜ'},type:1},{buttonId: `${prefix}donasi`,buttonText:{displayText: 'ᴅᴏɴᴀsɪ'},type:1},{buttonId: `${prefix}owner`,buttonText:{displayText: 'ᴏᴡɴᴇʀ'},type:1}]

               imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/Ramdani3.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Ramdani3.jpg`)})).imageMessage

               buttonsMessage = {
               contentText: `${allmenu}`,
               footerText: 'ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴅᴏɴᴀsɪ ʏᴀ ᴛᴏᴛ, ᴄᴀᴘᴇ ᴄᴏᴅɪɴɢ ᴛᴇʀᴜs:ᴠ\nᴅᴀɴ ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴊᴏɪɴ ɢʀᴜᴘ ɢᴡ ʏᴀ ᴛᴏᴛ\nɢʀᴜᴘ jb Abay: https://chat.whatsapp.com/JRnKnELSuEAETQrLaD5Qmp 2. https://chat.whatsapp.com/FGcmcBXM5P44Edj3h0slgP\n© ᴄʀᴇᴀᴛᴏʀ ʙʏ Abay ᴏғғɪᴄɪᴀʟ⸙', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
               ...
               buttonsMessage = {
               contentText: `${man}`,
               footerText: '© Creator by Ramdani Offcial', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
        ...
        case 'command':
               list = []
               listmenu = [`storemenu`,`infomenu`,`groupmenu`,`gamemenu`,`islammenu`,`downloadmenu`,`makermenu`,`sertimenu`,`stickermenu`,`soundmenu`,`toolsmenu`,`statusmenu`,`dewasamenu`,`othermenu`,`warmenu`,`hiburan menu`,`hewanmenu`,`beritamenu`,`wibumenu`,`randommenu`,`ownermenu`,`spammenu`,`searchmenu`,`funmenu`,`memesmenu`]
               listmenuu = [`Store Menu`,`Info Menu`,`Group Menu`,`Game Menu`,`Islam Menu`,`Download Menu`,`Maker Menu`,`Serti Menu`,`Sticker Menu`,`Sound Menu`,`Tools Menu`,`Status Menu`,`Dewasa Menu`,`Other Menu`,`War Menu`,`Hiburan Menu`,`Hewan Menu`,`Berita Menu`,`Wibu Menu`,`Random Menu`,`Owner Menu`,`Spam Menu`,`Search Menu`,`Fun Menu`,`Meme Menu`]
               nombor = 1
               startnum = 0
...
*Dengan cara, Ketik* ${prefix}owner *Ya!*`
              Ramdani.sendMessage(from, await getBuffer(gopeynya), image, {quoted: mek, caption: teksnya })
              break             
//------------------< bayar menu >-------------------  
case 'bayar':
gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani2.jpg'
...
//sewa bot 
case 'sewabot':
        sewa =`*Hai Kak👋 ${pushname} ${ucapanWaktu}*
...
➪ *_GOPAY_*: 087788069091  A/N ABAY STORE
➪ *_DANA_*: 087788069091 A/N RE** HER**** YAN**

                      *_SERTAKAN BUKTI TF!!_*
╚════════════•| ✿ |•═════════════╝
`
               buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: 'ᴏᴡɴᴇʀ'},type:1}]

               imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/Ramdani3.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Ramdani3.jpg`)})).imageMessage

               buttonsMessage = {
               contentText: `${sewa}`,
               footerText: 'hubuungi owner untuk sewa bot\n© Abay 𝐶ℎ𝑎𝑛𝑒𝑙᭄𓅂', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*[Wait] Tunggu Sebentar..*`
				...
				Ramdani.sendMessage(from, buffer1, video, {mimetype: 'video/mp4', filename: `${anu.result.video}.mp4`, quoted:freply, caption: 'Nih Gan'})
					break  
				case 'play':
              if (!q) return reply('Linknya?')
...
//------------------< Stalk >-------------------
      case 'stalkgithub':
      case 'githubstalk':
              if (args.length == 0) return reply(`Example: ${prefix + command} Ramdani-chan02`)
              reply(mess.wait)
              username = args[0]
...
`
      ...
      case 'stalkig':
      case 'igstalk':
             if (args.length == 0) return reply(`Example: ${prefix + command} Ramdani.chan26`)
             reply(mess.wait)
             username = args[0]
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              Ramdani.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *© Abay 𝐶ℎ𝑎𝑛𝑒𝑙᭄𓅂* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
Ramdani.sendMessage(from, tapib1, document, { quoted: mek, filename:`Ramdani Official ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
"groupName": `Ramdani Official ~ 404 ${vipi}`,
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Subcribe YT Owner :*\n https://youtube.com/channel/UC8QNuMGL46GioqhJClPjYwA`)
              break
case 'y':
reply ('Y')
break
       case 'masukandata':
             reply(`*「BOT MELAYANI」*\n\n━━━━━━━━━━━━━━━━━━━━\n\nMASUKKANA DATA BERIKUT\n*•NAMA GAME:*\n*•ID GAME:*\n*•USER NAME:*\n━━━━━━━━━━━━━━━━━━━━\n*NOTE:*\n*1.* _JANGAN LUPA BUKTI TRXNYA_\n*2.* _CHAT OWNER JIKA SUDAH TF_\n_LANSUNG DI PROSES_\n*3.* _PESANAN ANDA AKAN DI PROSES JIKA NGECHAT OWNER_\n_OLEH_\n\n   *© Abay 𝐶ℎ𝑎𝑛𝑒𝑙᭄𓅂*\n\n_JIKA PESANAN ANDA LOW_\n_PROSES MOHON BERSABAR_\nwa.me/6287788069091`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
//------------------< Lainnya >-------------------
        ...
        case 'getpp':
               if (mek.message.extendedTextMessage === null || mek.message.extendedTextMessage === undefined) {
               linkpp = await Ramdani.getProfilePicture(from) || "https://telegra.ph/file/40151a65238ba2643152d.jpg"
               buffer = await getBuffer(linkpp)
               Ramdani.sendMessage(from, buffer, image, {caption: "Nih", quoted: mek })
               } else if (mek.message.extendedTextMessage.contextInfo.mentionedJid === null || mek.message.extendedTextMessage.contextInfo.mentionedJid === undefined) {
               mberr = mek.message.extendedTextMessage.contextInfo.participant
               linkpp = await Ramdani.getProfilePicture(mberr) || "https://telegra.ph/file/40151a65238ba2643152d.jpg"
               buffer = await getBuffer(linkpp)
               Ramdani.sendMessage(from, buffer, image, { quoted: mek, caption: `Profile Picture of @${mberr.split("@")[0]}`, contextInfo: { "mentionedJid": [mberr] }})
        ...
        case 'infobot':  // Jangan Di Ubah Plise
               gopeynya = 'https://i.ibb.co/kynNYTh/Ramdani2.jpg'
               thankslort = `━━━━━ *INFO BOT* ━━━━━\n➤ *BOT INI MENGGUNAKAN SCRIPT BOT DARI ABAY OFFICIAL, JIKA INGIN MENDAPATKAN SC INI, TEKAN LINK DI BAWAH INI!!!*\n➤ *LINK YT ABAY OFFICIAL : https://youtube.com/channel/UC8QNuMGL46GioqhJClPjYwA*\n➤ *RUN BOT : TERMUX*\n➤ *TIPE : NODE JS*\n➤ *BASE : ABAY OFFICIAL*\n*━━━━━━━━━━━━━━━━━━━━*`
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              Ramdani.sendMessage('6287788069091@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
└⬣`)
      ...
      case 'qris':      
        qris =`*SCAN QRIS NYA OM, TEEF SEIHKLASNYA🗿*`
               ...
               imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/qris.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/qris.jpg`)})).imageMessage

               buttonsMessage = {
               contentText: `${qris}`,
               footerText: '© Abay 𝐶ℎ𝑎𝑛𝑒𝑙᭄𓅂', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
//----------------<store menu>----------------
               ...
               case 'sm':
               list = []
               listgame = [`sewabot`,`buttonml`,`buttonff`,`buttonpubg`,`buttonssm`,`buttonpb`]
               listgamee= [`Sewa Bot`,`Mobile Legends`,`Free Fire`,`Pubg`,`Sausage Man`,`Point Blank`]
               nombor = 1
               startnum = 0
               for (let x of listgame) {
               const yy = {title: 'Menu ' + nombor++,
                    rows: [
                       {
                        title: `${listgamee[startnum++]}`,
                        description: ``,
                        rowId: `${prefix}${x}`
                      }
                    ]
               ...
               listmsg(from, `${ucapanWaktu}`,  `*Hallo Kak* ${pushname}\nSilahkan Pilih Gamenya Disini`, list)
               break        
        case 'buttonml':
        case 'mobile legends':
        case 'mobilelegends':
...
CHAT OWNER Wa.me/6287788069091
...
➖➖➖➖➖➖➖➖➖➖➖`
               ...
               imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/ML.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/ML.jpg`)})).imageMessage
...
➖➖➖➖➖➖➖➖➖➖➖`
               ...
               imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/FF.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/FF.jpg`)})).imageMessage
...
➖➖➖➖➖➖➖➖➖➖➖`
               ...
               imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/PUBG.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/PUBG.jpg`)})).imageMessage
...
➖➖➖➖➖➖➖➖➖➖➖`
               ...
               imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/PB.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/PB.jpg`)})).imageMessage
...
➖➖➖➖➖➖➖➖➖➖➖`
               ...
               imageMsg = (await Ramdani.prepareMessageMedia(fs.readFileSync(`./media/SSM.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/SSM.jpg`)})).imageMessage
...
//payment                
      case 'dana':
             reply(`DANA : 087788069091`)
             break
           case 'gopay':
             reply(`*Goopay :* 087788069091`)
             break  
         case 'pulsa':
             reply(`*Pulsa :* 087788069091`)
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/frda_iqbal91`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/JRnKnELSuEAETQrLaD5Qmp , https://chat.whatsapp.com/FGcmcBXM5P44Edj3h0slgP')
             break
//case menu
      case 'ownermenu':
      ...
      case 'rules':
       ...
       case 'owner':
             ...
             break
      case 'wibumenu':
             Ramdani.sendMessage(from, wibuMenu(prefix), MessageType.text, {quoted: troli})
             break
      case 'infomenu':
     ...
     case 'toolsmenu':
      ...
      case 'funmenu':
             ...
             break
             case 'memesmenu':
             Ramdani.sendMessage(from, memesMenu(prefix), MessageType.text, {quoted: troli})
             break
//--------------<soundnya vang:v>-----------------
...
//---------------<sound antitoxic>----------------
             ...
             Ramdani.sendMessage(from, toxic, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
             break
...
case 'banteng':
case 'kelalawar':
reply(`*MOHON MAAF FITUR INI SEDANG MAINTENANCE/DI PERBARUI!!!*`)
...
break
  ...
  case 'allmenu':{
					if(MessageType == 'templateLocation'){
						var but = [
						{
							"urlButton": {
								...
								},
								{
									"urlButton": {
										...
										"url": `https://www.blogger.com/profile/17036195330028773073`
										}
										},
										{
											"quickReplyButton": {
							...
							await Ramdani.sendMessage(from, lang.menunya(salam, pushname) , `© Ramdani Official`,pp_bot, but )
							}
						if(typemenu == 'templateTenor'){
							...
							Ramdani.sendMessage(from, lang.menunya(salam, pushname) , `© ${ownername}` ,pp_bot, but , {quoted: m})
						 }
					}
					break
...
Ramdani.sendMessage(from, {text:teks, jpegThumbnail:fs.readFileSync('./media/Ramdani1.jpg')}, 'extendedTextMessage', {sendEphemeral:true, quoted:mek, contextInfo:{ forwardingScore:508, isForwarded:true, mentionedJid:[senderr]}})
}
	} 
